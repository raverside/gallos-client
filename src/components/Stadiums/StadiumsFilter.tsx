    ...
    return (<form className="users-filter-form" onSubmit={Submit}>
        <div className="users-filter-wrapper">
            <div className="users-filter-header">
                <IonButton fill="clear" onClick={clear}>{t('stadiums.filter_clear')}</IonButton>
                <IonText>{t('stadiums.filter_header')}</IonText>
                <IonButton fill="clear" onClick={close}>{t('stadiums.filter_cancel')}</IonButton>
            </div>
            <IonList>
                ...
                <IonLabel>{t('stadiums.filter_membership_type')}</IonLabel>
                <IonItem lines="none">
                    <IonSelect interface="alert" name="membership" value={membership} onIonChange={(e) => setMembership(e.detail.value)} placeholder={t('stadiums.filter_membership_type')}>
