...
import {formatOzToLbsOz, getParticipantBettingAmount} from "../utils";
        ...
        <div ref={ref} style={{textAlign:"center", width: "80mm", fontSize: "14px", fontFamily: "Arial"}}>
            ...
            <div style={{width: "100%"}}>
                <div>
                    ...
                    <div style={{display:"flex", justifyContent: "space-between"}}>
                        <div style={{textAlign: "center", width: "25mm"}}>{getParticipantBettingAmount(match.participant, event)}</div>
